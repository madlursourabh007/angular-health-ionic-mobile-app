...
@Injectable()
export class MSSPUpdateEducationalInfoSaveService extends URLConfig {
    ...
    saveEducationalInfo(educationalInfoSaveModal : MSSPEducationalInfoSaveModal,
        educationalInfoID : string) : Observable<any>{
       ...
       let body = {
        ...
        "id" : educationalInfoID,
        "documents" : this.createDocumentsArrayAsPerService()
       }
        return this._http.put(this.getMSSPEducationalInfoUpdateServiceURL()+educationalInfoID,body).pipe(
            map(res=>res),
